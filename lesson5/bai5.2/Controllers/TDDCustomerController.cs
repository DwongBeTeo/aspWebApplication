...
namespace bai5._2.Controllers
{
    public class TDDCustomerController : Controller
    {
        ...
        static bai5._2.Models.CustomerRepository listCustomer;
        public TDDCustomerController()
        {
            //khởi tạo CustomerRepository
            listCustomer = new bai5._2.Models.CustomerRepository();
        }
        ...
        [HttpPost]
        public ActionResult Create(bai5._2.Models.TDDCustomer cus)
        {
        ...
        // POST: /Customer/Edit
        [HttpPost]
        public ActionResult Edit(bai5._2.Models.TDDCustomer cus)
        {
