...
namespace lesson2_bai1._1.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            List<lesson2_bai1._1.Models.TranDangDuongStudent> listStudent = new List<lesson2_bai1._1.Models.TranDangDuongStudent>();
            listStudent.Add(new lesson2_bai1._1.Models.TranDangDuongStudent()
            {
                ID = 001,
        ...
        {
            byte[] fileBytes =
            System.IO.File.ReadAllBytes(Server.MapPath("~/Content/Nơi Tình Yêu Bắt Đầu  Bùi Anh Tuấn.mp3"));
            string fileName = "Nơi Tình Yêu Bắt Đầu  Bùi Anh Tuấn.mp3";
            //return File(fileBytes,System.Net.Mime.MediaTypeNames.Application.Octet, fileName);
            return File(fileBytes, "mp3", fileName);
        }
        public FileStreamResult TestFileStreamResult()
        {
            string pathFile = Server.MapPath("~/Content/ĐỒ ÁN CHUYÊN MÔN.docx");
            string fileName = "ĐỒ ÁN CHUYÊN MÔN.docx";
